...
static const std::vector< std::vector<std::string> > topModuleList = {
	...
	{"~/.scripts/statusbar/wlan",      "external",       "60",   "0"},
	{"~/.scripts/statusbar/netspeed",  "external",       "1",    "0"},
	{"~/.scripts/statusbar/volume",    "external",       "0",    "10"},
	{"~/.scripts/statusbar/memory",    "external",       "5",    "0"},
	{"~/.scripts/statusbar/cpu",       "external",       "5",    "0"},
	{"~/.scripts/statusbar/temp",      "external",       "5",    "0"},
	{"~/.scripts/statusbar/battery",   "external",       "5",    "0"},
	{"~/.scripts/statusbar/clock",     "external",       "60",   "0"},
};
 ...
 */
static const std::vector<std::string> fsNames{"/home", "/home/elianiva/"};
